...
- [Quickstart](/idsigning/quickstart) — create an identity and see it in action
- [Authentication](/idsigning/authentication) — how identities authenticate agents and services
- [Sign Commits](/idsigning/sign-commits) — how identity binds to Git commits
