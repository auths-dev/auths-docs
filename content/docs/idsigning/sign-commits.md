...
Signing a commit proves that **you** authored it — provably, offline, with no central server or API key. This guide assumes you've already installed Auths and run `auths init` (see the [quickstart](/idsigning/quickstart)).
...
See [Team Identities](/idsigning/team-identities) for sharing identities across a team.
...
- [Prove provenance](/idsigning/prove-provenance) — verify ranges, artifacts, and CI builds
- [Team identities](/idsigning/team-identities) — share and trust identities across a team
- [Key rotation](/idsigning/concepts/key-rotation) — how rotation preserves historical validity
