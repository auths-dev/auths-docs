...
export default async function Page() {
  const source = fs.readFileSync(path.join(process.cwd(), 'content/docs/prove-provenance.md'), 'utf8')
...
export function generateMetadata() {
  return { title: 'Prove Provenance - Auths Docs', description: 'Verify the authenticity and origin of code commits' }
}
