...
export default async function Page() {
  const source = fs.readFileSync(path.join(process.cwd(), 'content/docs/installation.md'), 'utf8')
...
export function generateMetadata() {
  return { title: 'Installation - Auths Docs', description: 'Get the Auths CLI up and running' }
}
