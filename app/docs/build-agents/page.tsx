...
export default async function Page() {
  const source = fs.readFileSync(path.join(process.cwd(), 'content/docs/build-agents.md'), 'utf8')
...
export function generateMetadata() {
  return { title: 'Build Agents - Auths Docs', description: 'Automate code signing with agents in your CI/CD pipeline' }
}
